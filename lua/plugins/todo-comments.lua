return {
  ...
  config = function(_, opts)
    ...
    -- Add autocmd to highlight TODO comments in new file types
    vim.api.nvim_create_autocmd("FileType", {
      pattern = { "bicep", "terraform", "hcl" },
      callback = function()
        -- Ensure TODO comments work in your specific file types
        vim.b.todo_comments_enabled = true
      end,
    })
  end,
}